...
const ImageSVG = (props: React.SVGProps<SVGSVGElement>) => {
  return (
<svg {...props} viewBox="0 -2 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs>
